  ...
  module DailyUpdate
    module Operation
      class Load < Trailblazer::Operation
        ...
        pass ->(_, logger:, **) { logger.info('Fetching new daily updates to import...') }
        step Nested(DBCurrentDate)
        step ->(_, logger:, db_current_date:, **) { logger.info("The database is sync until the date #{db_current_date}.") }
        ...
        def no_updates_to_import(_, db_current_date:, logger:, **)
