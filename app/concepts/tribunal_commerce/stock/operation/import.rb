  ...
  module Stock
    module Operation
      class Import < Trailblazer::Operation
        ...
        step :drop_db_index
        step ->(_, logger:, **) { logger.info('Creating jobs to import each greffe\'s unit synchronously...') }
        step :import
        ...
        def stock_exists?(ctx, stock_args:, stocks_folder:, **)
          ...
          Dir.exist?(ctx[:stock_absolute_path])
        end
        ...
        def rollback_created_stock(_, new_stock:, **)
          new_stock.destroy
        end
      end
    end
