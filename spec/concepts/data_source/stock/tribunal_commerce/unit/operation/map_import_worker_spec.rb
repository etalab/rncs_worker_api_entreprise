...
describe DataSource::Stock::TribunalCommerce::Unit::Operation::MapImportWorker do
  pending 'fix those tests'
  ...
  #    step DataSource::Stock::TribunalCommerce::Unit::Operation::MapImportWorker
  #  end
  #end
